      ...
      <main className="flex-1">
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Fair. Transparent. Inklusiv. adlix consent macht es einfach, 
            gemeinsam zu entscheiden — ohne Hierarchien, mit Stimme für alle.
          </p>
        ...
        <section className="bg-gray-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              Der Consent-Prozess: Beschreibung → Abstimmung → Einspruch → 
              Diskussion → Anpassung → Neuer Loop
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
              <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-600">
                  Projekte in Minuten erstellen. Teilnehmer einladen. 
                  Abstimmungen in wenigen Klicks.
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <div className="text-3xl mb-4">🤝</div>
                ...
                <p className="text-gray-600">
                  Niemand wird überstimmt. Einsprüche ermöglichen 
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-600">
                  ...
                  Vollständige Historie inklusive.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Organisiere mehrere Consent-Projekte parallel. 
                    Behalte den Überblick über alle laufenden Abstimmungen.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Stimme zu, lehne ab oder enthalte dich. 
                    Ergebnisse werden transparent angezeigt.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Bedenken einbringen, diskutieren und adressieren. 
                    Kein Blocking ohne Grund.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Kommentare zu jeder Runde. 
                    Konstruktiver Austausch vor der Entscheidung.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Microsoft Teams Integration für Echtzeit-Updates 
                    zu neuen Abstimmungen und Einsprüchen.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Zugriff von überall: Desktop, Tablet oder Smartphone. 
                    Funktioniert überall gleich gut.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="pricing" className="bg-gray-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              Wähle den Plan, der zu dir passt. Alle Pläne inkludieren 
              das vollständige Consent-Workflow-Erlebnis.
            </p>
      ...
      <footer className="border-t border-gray-200 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-gray-500 text-sm">
            © 2026 adlix. Consent trifft Einfachheit.
          </p>
        </div>
      </footer>
    </div>
